...
- "Covered only by manual Hyper-V checkpoints" no longer holds. [[guest-layer-tested-against-real-hyperv]] boots a real Ubuntu guest onto an Internal switch with only a DHCP lease and asserts that DHCP supplied both router and resolver.
